          ...
          <h2 class="posts-h2">Создать категорию</h2>
            ...
            <?php include "../../app/helps/errInfo.php" ?>
                ...
                <div class="form-group">
                    ...
                    <label for="formGroupExampleInput" style="margin-bottom: 10px; color: white;">Ваш логин</label>
                    ...
                    <label for="exampleInputEmail1" style="margin-bottom: 10px; color: white;">Email адрес</label>
                    ...
                    <label for="exampleInputPassword1" style="margin-bottom: 10px; color: white;">Пароль</label>
